...
-   **H0-mock-divergence (pre-declared path)**: the MOCK probe's dump
    ...
    extends diagnosis on the runner evidence (e.g. a real-header lower
...
-   **H1 — double-creation/rename**: `BuildNonCppGlobalVariableDecl` runs
    twice for one var (uncached, :742-765) — e.g. once from constant
