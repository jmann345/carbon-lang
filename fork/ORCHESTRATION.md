...
_Last updated: 2026-09-21 (weekly upstream fold on the unlanded 08-24
staging merge: cut 631f8fb holds a FIFTH week — 09-21 A/B on the
mirrored nightly shows templates_value_param clean but
templates_type_param still crashing in lowering; deferred set 119
upstream commits; landing blocked only on runner jeromehome, offline
since 08-27 ~02:20Z, gate re-queued at attempt 48; W8a fully staged
at ee20c6951 awaiting the same runner — see fork/decision-log.md
weekly entries for the full record)._ THIRTY-ONE PRs. The design's canonical
